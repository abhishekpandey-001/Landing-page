    ...
    <div className="max-w-[60rem] mx-auto mb-20 px-[1.5rem]">
        <div className="grid grid-cols-3 gap-10 max-[730px]:grid-cols-2 max-[500px]:grid-cols-1">
            <div className="flex flex-col py-8 bg-[#F5F7F7] rounded-3xl items-center">
                <BsFolderSymlinkFill className="text-5xl text-[#0E6F6A] max-[500px]:text-3xl"/>
                ...
                <div className="flex flex-col py-8 bg-[#F5F7F7] rounded-3xl items-center">
                <BiSolidMessageAltCheck className="text-5xl text-[#0E6F6A] max-[500px]:text-3xl"/>
                ...
                <div className="flex flex-col py-8 bg-[#F5F7F7] rounded-3xl items-center">
                <AiFillThunderbolt className="text-5xl text-[#0E6F6A] max-[500px]:text-3xl"/>
